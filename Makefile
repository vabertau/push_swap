...
#    Updated: 2024/01/15 17:44:33 by vabertau         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRCS=sorting.c push_swap.c lst.c ops.c init_nodes.c cost_ops.c exec_atob.c exec_btoa.c binit_nodes.c bcost_ops.c minus_tobottom.c
